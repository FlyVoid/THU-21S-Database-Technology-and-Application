...
def loggedSession(username, password):
    ...
    res = requests.get("https://learn.tsinghua.edu.cn/f/login")
    ...
    res = session.get('https://learn.tsinghua.edu.cn/b/j_spring_security_thauth_roaming_entry?ticket='+ticket)
    res = session.get('https://learn.tsinghua.edu.cn/f/wlxt/common/courseSearch')
    return session
